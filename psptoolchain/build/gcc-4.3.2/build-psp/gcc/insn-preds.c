...
#line 22 "../../gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 30 "../../gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 38 "../../gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 42 "../../gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 50 "../../gcc/config/mips/predicates.md"
...
#line 54 "../../gcc/config/mips/predicates.md"
(INTVAL (op) + 1 != 0));
}
...
const_0_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 58 "../../gcc/config/mips/predicates.md"
...
#line 62 "../../gcc/config/mips/predicates.md"
...
const_1_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 67 "../../gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && ((
#line 76 "../../gcc/config/mips/predicates.md"
(op == CONST0_RTX (GET_MODE (op)))) || (
...
#line 81 "../../gcc/config/mips/predicates.md"
(FP_REG_P (REGNO (op))))) && (
...
{
  return ((GET_CODE (op) == REG) && (
#line 85 "../../gcc/config/mips/predicates.md"
(REGNO (op) == LO_REGNUM))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
fcc_reload_operand (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 89 "../../gcc/config/mips/predicates.md"
...
#line 96 "../../gcc/config/mips/predicates.md"
{
...
#line 141 "../../gcc/config/mips/predicates.md"
{
...
{
  return (
#line 213 "../../gcc/config/mips/predicates.md"
(CONSTANT_P (op))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 217 "../../gcc/config/mips/predicates.md"
{
...
#line 224 "../../gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &type)
...
#line 232 "../../gcc/config/mips/predicates.md"
{
  enum mips_symbol_type symbol_type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &symbol_type)
...
#line 240 "../../gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &type)
...
#line 248 "../../gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
  return (mips_symbolic_constant_p (op, SYMBOL_CONTEXT_LEA, &type)
...
#line 259 "../../gcc/config/mips/predicates.md"
...
#line 264 "../../gcc/config/mips/predicates.md"
{
...
#line 262 "../../gcc/config/mips/predicates.md"
(ISA_HAS_MACC))) || ((GET_CODE (op) == MINUS) && (
#line 263 "../../gcc/config/mips/predicates.md"
(ISA_HAS_MSAC)))) && (
...
small_data_pattern (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 289 "../../gcc/config/mips/predicates.md"
